...
public class SysAccountServiceImpl implements SysAccountService {
	...
	public ResponseVO login(String phone, String password) {
		...
		if(sysAccount==null){
			throw new BusinessException("password is false");
		}
		if(SysAccountStatusEnum.DISABLE.getStatus().equals(sysAccount.getStatus())){
			throw new BusinessException("The account is banned");

		}
		if(!sysAccount.getPassword().equals(password)){
			throw new BusinessException("Account or password is false");
		}
